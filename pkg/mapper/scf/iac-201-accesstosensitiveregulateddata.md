# SCF - IAC-20.1 - Access To Sensitive / Regulated Data
...
## Control questions
Does the organization limit access to sensitive/regulated data to only those individuals whose job requires such access?
...
## Control maturity
### Not performed
There is no evidence of a capability to limit access to sensitive/regulated data to only those individuals whose job requires such access.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to limit access to sensitive/regulated data to only those individuals whose job requires such access.
