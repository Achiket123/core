# SCF - IAC-06.4 - Out-of-Band Multi-Factor Authentication
...
## Control maturity
### Not performed
There is no evidence of a capability to implement Multi-Factor Authentication (MFA) for remote access to privileged and non-privileged accounts such that one of the factors is securely provided by a device separate from the system gaining access.
