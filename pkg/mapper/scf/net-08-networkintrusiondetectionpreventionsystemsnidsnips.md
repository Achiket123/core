# SCF - NET-08 - Network Intrusion Detection / Prevention Systems (NIDS / NIPS)
...
## Control questions
Does the organization employ Network Intrusion Detection / Prevention Systems (NIDS/NIPS) to detect and/or prevent intrusions into the network?
...
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to employ Network Intrusion Detection / Prevention Systems (NIDS/NIPS) to detect and/ or prevent intrusions into the network.
