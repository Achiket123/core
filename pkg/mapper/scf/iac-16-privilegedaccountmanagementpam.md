...
## Control maturity
### Not performed
There is no evidence of a capability to restrict and control privileged access rights for users and services.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to restrict and control privileged access rights for users and services.
