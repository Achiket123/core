...
## Control maturity
### Not performed
There is no evidence of a capability to audit account creation, modification, enabling, disabling and removal actions and notify organization-defined personnel or roles.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to audit account creation, modification, enabling, disabling and removal actions and notify organization-defined personnel or roles.
...
- Technologies are configured to implement automated maintenance actions, based on specific criteria and use cases.
