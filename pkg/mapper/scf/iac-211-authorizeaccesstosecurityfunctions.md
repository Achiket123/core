...
SP-CMM1 is N/A, since a structured process is required to limit access to security functions to explicitly-authorized privileged users.
...
See SP-CMM3. SP-CMM4 is N/A, since a quantitatively-controlled process is not necessary to limit access to security functions to explicitly-authorized privileged users.

### Continuously improving
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to limit access to security functions to explicitly-authorized privileged users.
