...
## Control questions
Does the organization use automated mechanisms to govern and report on baseline configurations of systems through Continuous Diagnostics and Mitigation (CDM), or similar technologies?
...
## Control maturity
### Not performed
There is no evidence of an automated capability to govern and report on baseline configurations of systems through Continuous Diagnostics and Mitigation (CDM), or similar technologies.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to govern and report on baseline configurations of systems through Continuous Diagnostics and Mitigation (CDM), or similar technologies.
