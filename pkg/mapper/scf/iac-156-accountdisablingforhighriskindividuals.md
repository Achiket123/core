...
## Control maturity
### Not performed
There is no evidence of a capability to disable accounts immediately up on notification for users posing a significant risk to the organization.
...
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to disable accounts immediately up on notification for users posing a significant risk to the organization.
