# SCF - NET-03.3 - Prevent Discovery of Internal Information
...
## Control maturity
### Not performed
There is no evidence of a capability to prevent the public disclosure of internal network information.
...
See SP-CMM3. SP-CMM4 is N/A, since a quantitatively-controlled process is not necessary to prevent the public disclosure of internal network information.

### Continuously improving
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to prevent the public disclosure of internal network information.
