...
## Control maturity
### Not performed
There is no evidence of a capability to mask sensitive/regulated data through data anonymization, pseudonymization, redaction or de-identification.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to mask sensitive/regulated data through data anonymization, pseudonymization, redaction or de-identification.

### Planned and tracked
SP-CMM2 is N/A, since a well-defined process is required to mask sensitive/regulated data through data anonymization, pseudonymization, redaction or de-identification.
...
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to mask sensitive/regulated data through data anonymization, pseudonymization, redaction or de-identification.
