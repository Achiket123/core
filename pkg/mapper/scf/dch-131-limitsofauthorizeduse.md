...
## Control maturity
### Not performed
There is no evidence of a capability to prohibit external parties, systems and services from storing, processing and transmitting data unless authorized individuals first:
 •Verifying the implementation of required security controls; or
 •Retaining a processing agreement with the entity hosting the external systems or service.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to prohibit external parties, systems and services from storing, processing and transmitting data unless authorized individuals first:
 •Verifying the implementation of required security controls; or
 •Retaining a processing agreement with the entity hosting the external systems or service.
...
See SP-CMM3. SP-CMM4 is N/A, since a quantitatively-controlled process is not necessary to prohibit external parties, systems and services from storing, processing and transmitting data unless authorized individuals first:
 •Verifying the implementation of required security controls; or
 •Retaining a processing agreement with the entity hosting the external systems or service.

### Continuously improving
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to prohibit external parties, systems and services from storing, processing and transmitting data unless authorized individuals first:
 •Verifying the implementation of required security controls; or
 •Retaining a processing agreement with the entity hosting the external systems or service.
