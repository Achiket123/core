...
## Control maturity
### Not performed
There is no evidence of a capability to audit the execution of privileged functions.
...
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to audit the execution of privileged functions.
