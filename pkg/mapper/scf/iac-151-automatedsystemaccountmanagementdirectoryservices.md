...
## Control maturity
### Not performed
There is no evidence of a capability to support the management of system accounts.

### Performed internally
SP-CMM1 is N/A, since a structured process is required to support the management of system accounts.
...
See SP-CMM3. SP-CMM4 is N/A, since a quantitatively-controlled process is not necessary to support the management of system accounts.

### Continuously improving
See SP-CMM4. SP-CMM5 is N/A, since a continuously-improving process is not necessary to support the management of system accounts.
