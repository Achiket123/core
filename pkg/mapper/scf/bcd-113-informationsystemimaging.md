# SCF - BCD-11.3 - Information System Imaging
...
- IT personnel have a limited capability to re-image, or configure, assets from configuration-controlled and integrity-protected images or scripts (infrastructure as code).Limited technologies exist to conduct full, incremental or differential backups (e.g., tape/disk, hybrid cloud or direct-to-cloud).
