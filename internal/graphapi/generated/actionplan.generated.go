...
type MutationResolver interface {
	...
	CreateGroupByClone(ctx context.Context, group generated.CreateGroupInput, members []*model.GroupMembersInput, inheritGroupPermissions *string, cloneGroupMembers *string) (*model.GroupCreatePayload, error)
...
func (ec *executionContext) field_Mutation_createGroupByClone_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_createGroupByClone_argsGroup(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["group"] = arg0
...
func (ec *executionContext) field_Mutation_createGroupByClone_argsGroup(
	ctx context.Context,
	rawArgs map[string]any,
) (generated.CreateGroupInput, error) {
...
func (ec *executionContext) _Mutation_createGroupByClone(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateGroupByClone(rctx, fc.Args["group"].(generated.CreateGroupInput), fc.Args["members"].([]*model.GroupMembersInput), fc.Args["inheritGroupPermissions"].(*string), fc.Args["cloneGroupMembers"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
