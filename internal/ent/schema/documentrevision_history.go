...
// DocumentRevisionHistory holds the schema definition for the DocumentRevisionHistory entity.
type DocumentRevisionHistory struct {
	ent.Schema
}

// Annotations of the DocumentRevisionHistory.
func (DocumentRevisionHistory) Annotations() []schema.Annotation {
...
// Fields of the DocumentRevisionHistory.
func (DocumentRevisionHistory) Fields() []ent.Field {
...
// Indexes of the DocumentRevisionHistory
func (DocumentRevisionHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the DocumentRevisionHistory
func (DocumentRevisionHistory) Interceptors() []ent.Interceptor {
