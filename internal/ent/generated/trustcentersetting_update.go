...
func (tcsu *TrustCenterSettingUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tcsu.mutation.LogoLocalFileID(); ok {
		_spec.SetField(trustcentersetting.FieldLogoLocalFileID, field.TypeString, value)
	}
	if tcsu.mutation.LogoLocalFileIDCleared() {
		_spec.ClearField(trustcentersetting.FieldLogoLocalFileID, field.TypeString)
	}
	...
	if value, ok := tcsu.mutation.FaviconLocalFileID(); ok {
		_spec.SetField(trustcentersetting.FieldFaviconLocalFileID, field.TypeString, value)
	}
	if tcsu.mutation.FaviconLocalFileIDCleared() {
		_spec.ClearField(trustcentersetting.FieldFaviconLocalFileID, field.TypeString)
	}
...
func (tcsuo *TrustCenterSettingUpdateOne) sqlSave(ctx context.Context) (_node *TrustCenterSetting, err error) {
	...
	if value, ok := tcsuo.mutation.LogoLocalFileID(); ok {
		_spec.SetField(trustcentersetting.FieldLogoLocalFileID, field.TypeString, value)
	}
	if tcsuo.mutation.LogoLocalFileIDCleared() {
		_spec.ClearField(trustcentersetting.FieldLogoLocalFileID, field.TypeString)
	}
	...
	if value, ok := tcsuo.mutation.FaviconLocalFileID(); ok {
		_spec.SetField(trustcentersetting.FieldFaviconLocalFileID, field.TypeString, value)
	}
	if tcsuo.mutation.FaviconLocalFileIDCleared() {
		_spec.ClearField(trustcentersetting.FieldFaviconLocalFileID, field.TypeString)
	}
