...
// HasAssessmentResponseEditors applies the HasEdge predicate on the "assessment_response_editors" edge.
func HasAssessmentResponseEditors() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasAssessmentResponseEditorsWith applies the HasEdge predicate on the "assessment_response_editors" edge with a given conditions (other predicates).
func HasAssessmentResponseEditorsWith(preds ...predicate.AssessmentResponse) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newAssessmentResponseEditorsStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.AssessmentResponse
		step.Edge.Schema = schemaConfig.AssessmentResponseEditors
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
...
// HasAssessmentResponseBlockedGroups applies the HasEdge predicate on the "assessment_response_blocked_groups" edge.
func HasAssessmentResponseBlockedGroups() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasAssessmentResponseBlockedGroupsWith applies the HasEdge predicate on the "assessment_response_blocked_groups" edge with a given conditions (other predicates).
func HasAssessmentResponseBlockedGroupsWith(preds ...predicate.AssessmentResponse) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newAssessmentResponseBlockedGroupsStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.AssessmentResponse
		step.Edge.Schema = schemaConfig.AssessmentResponseBlockedGroups
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
...
// HasAssessmentResponseViewers applies the HasEdge predicate on the "assessment_response_viewers" edge.
func HasAssessmentResponseViewers() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasAssessmentResponseViewersWith applies the HasEdge predicate on the "assessment_response_viewers" edge with a given conditions (other predicates).
func HasAssessmentResponseViewersWith(preds ...predicate.AssessmentResponse) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newAssessmentResponseViewersStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.AssessmentResponse
		step.Edge.Schema = schemaConfig.AssessmentResponseViewers
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
