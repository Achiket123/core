...
const (
	// Label holds the string label denoting the documentrevisionhistory type in the database.
	Label = "document_revision_history"
	...
	// Table holds the table name of the documentrevisionhistory in the database.
	Table = "document_revision_history"
)

// Columns holds all SQL columns for documentrevisionhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("documentrevisionhistory: invalid enum value for operation field: %q", o)
	}
}
...
func StatusValidator(s enums.ApprovalStatus) error {
	...
	case "APPROVED", "PENDING", "REJECTED":
		return nil
	default:
		return fmt.Errorf("documentrevisionhistory: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the DocumentRevisionHistory queries.
