...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[13] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   documentrevision.Table,
			Columns: documentrevision.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeString,
				Column: documentrevision.FieldID,
			},
		},
		Type: "DocumentRevision",
		Fields: map[string]*sqlgraph.FieldSpec{
			documentrevision.FieldCreatedAt:        {Type: field.TypeTime, Column: documentrevision.FieldCreatedAt},
			documentrevision.FieldUpdatedAt:        {Type: field.TypeTime, Column: documentrevision.FieldUpdatedAt},
			documentrevision.FieldCreatedBy:        {Type: field.TypeString, Column: documentrevision.FieldCreatedBy},
			documentrevision.FieldUpdatedBy:        {Type: field.TypeString, Column: documentrevision.FieldUpdatedBy},
			documentrevision.FieldDeletedAt:        {Type: field.TypeTime, Column: documentrevision.FieldDeletedAt},
			documentrevision.FieldDeletedBy:        {Type: field.TypeString, Column: documentrevision.FieldDeletedBy},
			documentrevision.FieldTags:             {Type: field.TypeJSON, Column: documentrevision.FieldTags},
			documentrevision.FieldRevision:         {Type: field.TypeString, Column: documentrevision.FieldRevision},
			documentrevision.FieldDetails:          {Type: field.TypeString, Column: documentrevision.FieldDetails},
			documentrevision.FieldStatus:           {Type: field.TypeEnum, Column: documentrevision.FieldStatus},
			documentrevision.FieldApprovalDate:     {Type: field.TypeTime, Column: documentrevision.FieldApprovalDate},
			documentrevision.FieldSubmittedByID:    {Type: field.TypeString, Column: documentrevision.FieldSubmittedByID},
			documentrevision.FieldApprovedByID:     {Type: field.TypeString, Column: documentrevision.FieldApprovedByID},
			documentrevision.FieldInternalPolicyID: {Type: field.TypeString, Column: documentrevision.FieldInternalPolicyID},
			documentrevision.FieldProcedureID:      {Type: field.TypeString, Column: documentrevision.FieldProcedureID},
			documentrevision.FieldActionPlanID:     {Type: field.TypeString, Column: documentrevision.FieldActionPlanID},
		},
	}
	graph.Nodes[14] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   documentrevisionhistory.Table,
			Columns: documentrevisionhistory.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeString,
				Column: documentrevisionhistory.FieldID,
			},
		},
		Type: "DocumentRevisionHistory",
		Fields: map[string]*sqlgraph.FieldSpec{
			documentrevisionhistory.FieldHistoryTime:      {Type: field.TypeTime, Column: documentrevisionhistory.FieldHistoryTime},
			documentrevisionhistory.FieldRef:              {Type: field.TypeString, Column: documentrevisionhistory.FieldRef},
			documentrevisionhistory.FieldOperation:        {Type: field.TypeEnum, Column: documentrevisionhistory.FieldOperation},
			documentrevisionhistory.FieldCreatedAt:        {Type: field.TypeTime, Column: documentrevisionhistory.FieldCreatedAt},
			documentrevisionhistory.FieldUpdatedAt:        {Type: field.TypeTime, Column: documentrevisionhistory.FieldUpdatedAt},
			documentrevisionhistory.FieldCreatedBy:        {Type: field.TypeString, Column: documentrevisionhistory.FieldCreatedBy},
			documentrevisionhistory.FieldUpdatedBy:        {Type: field.TypeString, Column: documentrevisionhistory.FieldUpdatedBy},
			documentrevisionhistory.FieldDeletedAt:        {Type: field.TypeTime, Column: documentrevisionhistory.FieldDeletedAt},
			documentrevisionhistory.FieldDeletedBy:        {Type: field.TypeString, Column: documentrevisionhistory.FieldDeletedBy},
			documentrevisionhistory.FieldTags:             {Type: field.TypeJSON, Column: documentrevisionhistory.FieldTags},
			documentrevisionhistory.FieldRevision:         {Type: field.TypeString, Column: documentrevisionhistory.FieldRevision},
			documentrevisionhistory.FieldDetails:          {Type: field.TypeString, Column: documentrevisionhistory.FieldDetails},
			documentrevisionhistory.FieldStatus:           {Type: field.TypeEnum, Column: documentrevisionhistory.FieldStatus},
			documentrevisionhistory.FieldApprovalDate:     {Type: field.TypeTime, Column: documentrevisionhistory.FieldApprovalDate},
			documentrevisionhistory.FieldSubmittedByID:    {Type: field.TypeString, Column: documentrevisionhistory.FieldSubmittedByID},
			documentrevisionhistory.FieldApprovedByID:     {Type: field.TypeString, Column: documentrevisionhistory.FieldApprovedByID},
			documentrevisionhistory.FieldInternalPolicyID: {Type: field.TypeString, Column: documentrevisionhistory.FieldInternalPolicyID},
			documentrevisionhistory.FieldProcedureID:      {Type: field.TypeString, Column: documentrevisionhistory.FieldProcedureID},
			documentrevisionhistory.FieldActionPlanID:     {Type: field.TypeString, Column: documentrevisionhistory.FieldActionPlanID},
		},
	}
...
// WhereHasDocumentRevisions applies a predicate to check if query has an edge document_revisions.
func (f *ActionPlanFilter) WhereHasDocumentRevisions() {
	f.Where(entql.HasEdge("document_revisions"))
}

// WhereHasDocumentRevisionsWith applies a predicate to check if query has an edge document_revisions with a given conditions (other predicates).
func (f *ActionPlanFilter) WhereHasDocumentRevisionsWith(preds ...predicate.DocumentRevision) {
	f.Where(entql.HasEdgeWith("document_revisions", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (drq *DocumentRevisionQuery) addPredicate(pred func(s *sql.Selector)) {
	drq.predicates = append(drq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the DocumentRevisionQuery builder.
func (drq *DocumentRevisionQuery) Filter() *DocumentRevisionFilter {
	return &DocumentRevisionFilter{config: drq.config, predicateAdder: drq}
}

// addPredicate implements the predicateAdder interface.
func (m *DocumentRevisionMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the DocumentRevisionMutation builder.
func (m *DocumentRevisionMutation) Filter() *DocumentRevisionFilter {
	return &DocumentRevisionFilter{config: m.config, predicateAdder: m}
}

// DocumentRevisionFilter provides a generic filtering capability at runtime for DocumentRevisionQuery.
type DocumentRevisionFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *DocumentRevisionFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql string predicate on the id field.
func (f *DocumentRevisionFilter) WhereID(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *DocumentRevisionFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(documentrevision.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *DocumentRevisionFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(documentrevision.FieldUpdatedAt))
}

// WhereCreatedBy applies the entql string predicate on the created_by field.
func (f *DocumentRevisionFilter) WhereCreatedBy(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql string predicate on the updated_by field.
func (f *DocumentRevisionFilter) WhereUpdatedBy(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldUpdatedBy))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *DocumentRevisionFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(documentrevision.FieldDeletedAt))
}

// WhereDeletedBy applies the entql string predicate on the deleted_by field.
func (f *DocumentRevisionFilter) WhereDeletedBy(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldDeletedBy))
}

// WhereTags applies the entql json.RawMessage predicate on the tags field.
func (f *DocumentRevisionFilter) WhereTags(p entql.BytesP) {
	f.Where(p.Field(documentrevision.FieldTags))
}

// WhereRevision applies the entql string predicate on the revision field.
func (f *DocumentRevisionFilter) WhereRevision(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldRevision))
}

// WhereDetails applies the entql string predicate on the details field.
func (f *DocumentRevisionFilter) WhereDetails(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldDetails))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *DocumentRevisionFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldStatus))
}

// WhereApprovalDate applies the entql time.Time predicate on the approval_date field.
func (f *DocumentRevisionFilter) WhereApprovalDate(p entql.TimeP) {
	f.Where(p.Field(documentrevision.FieldApprovalDate))
}

// WhereSubmittedByID applies the entql string predicate on the submitted_by_id field.
func (f *DocumentRevisionFilter) WhereSubmittedByID(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldSubmittedByID))
}

// WhereApprovedByID applies the entql string predicate on the approved_by_id field.
func (f *DocumentRevisionFilter) WhereApprovedByID(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldApprovedByID))
}

// WhereInternalPolicyID applies the entql string predicate on the internal_policy_id field.
func (f *DocumentRevisionFilter) WhereInternalPolicyID(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldInternalPolicyID))
}

// WhereProcedureID applies the entql string predicate on the procedure_id field.
func (f *DocumentRevisionFilter) WhereProcedureID(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldProcedureID))
}

// WhereActionPlanID applies the entql string predicate on the action_plan_id field.
func (f *DocumentRevisionFilter) WhereActionPlanID(p entql.StringP) {
	f.Where(p.Field(documentrevision.FieldActionPlanID))
}

// WhereHasSubmittedBy applies a predicate to check if query has an edge submitted_by.
func (f *DocumentRevisionFilter) WhereHasSubmittedBy() {
	f.Where(entql.HasEdge("submitted_by"))
}

// WhereHasSubmittedByWith applies a predicate to check if query has an edge submitted_by with a given conditions (other predicates).
func (f *DocumentRevisionFilter) WhereHasSubmittedByWith(preds ...predicate.User) {
	f.Where(entql.HasEdgeWith("submitted_by", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *DocumentRevisionFilter) WhereHasApprovedBy() {
...
func (f *DocumentRevisionFilter) WhereHasApprovedByWith(preds ...predicate.User) {
...
func (f *DocumentRevisionFilter) WhereHasInternalPolicy() {
...
func (f *DocumentRevisionFilter) WhereHasInternalPolicyWith(preds ...predicate.InternalPolicy) {
...
func (f *DocumentRevisionFilter) WhereHasProcedure() {
...
func (f *DocumentRevisionFilter) WhereHasProcedureWith(preds ...predicate.Procedure) {
...
func (f *DocumentRevisionFilter) WhereHasActionPlan() {
...
func (f *DocumentRevisionFilter) WhereHasActionPlanWith(preds ...predicate.ActionPlan) {
...
// addPredicate implements the predicateAdder interface.
func (drhq *DocumentRevisionHistoryQuery) addPredicate(pred func(s *sql.Selector)) {
	drhq.predicates = append(drhq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the DocumentRevisionHistoryQuery builder.
func (drhq *DocumentRevisionHistoryQuery) Filter() *DocumentRevisionHistoryFilter {
	return &DocumentRevisionHistoryFilter{config: drhq.config, predicateAdder: drhq}
}

// addPredicate implements the predicateAdder interface.
func (m *DocumentRevisionHistoryMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the DocumentRevisionHistoryMutation builder.
func (m *DocumentRevisionHistoryMutation) Filter() *DocumentRevisionHistoryFilter {
	return &DocumentRevisionHistoryFilter{config: m.config, predicateAdder: m}
}

// DocumentRevisionHistoryFilter provides a generic filtering capability at runtime for DocumentRevisionHistoryQuery.
type DocumentRevisionHistoryFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *DocumentRevisionHistoryFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql string predicate on the id field.
func (f *DocumentRevisionHistoryFilter) WhereID(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldID))
}

// WhereHistoryTime applies the entql time.Time predicate on the history_time field.
func (f *DocumentRevisionHistoryFilter) WhereHistoryTime(p entql.TimeP) {
	f.Where(p.Field(documentrevisionhistory.FieldHistoryTime))
}

// WhereRef applies the entql string predicate on the ref field.
func (f *DocumentRevisionHistoryFilter) WhereRef(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldRef))
}

// WhereOperation applies the entql string predicate on the operation field.
func (f *DocumentRevisionHistoryFilter) WhereOperation(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldOperation))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *DocumentRevisionHistoryFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(documentrevisionhistory.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *DocumentRevisionHistoryFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(documentrevisionhistory.FieldUpdatedAt))
}

// WhereCreatedBy applies the entql string predicate on the created_by field.
func (f *DocumentRevisionHistoryFilter) WhereCreatedBy(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql string predicate on the updated_by field.
func (f *DocumentRevisionHistoryFilter) WhereUpdatedBy(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldUpdatedBy))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *DocumentRevisionHistoryFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(documentrevisionhistory.FieldDeletedAt))
}

// WhereDeletedBy applies the entql string predicate on the deleted_by field.
func (f *DocumentRevisionHistoryFilter) WhereDeletedBy(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldDeletedBy))
}

// WhereTags applies the entql json.RawMessage predicate on the tags field.
func (f *DocumentRevisionHistoryFilter) WhereTags(p entql.BytesP) {
	f.Where(p.Field(documentrevisionhistory.FieldTags))
}

// WhereRevision applies the entql string predicate on the revision field.
func (f *DocumentRevisionHistoryFilter) WhereRevision(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldRevision))
}

// WhereDetails applies the entql string predicate on the details field.
func (f *DocumentRevisionHistoryFilter) WhereDetails(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldDetails))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *DocumentRevisionHistoryFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldStatus))
}

// WhereApprovalDate applies the entql time.Time predicate on the approval_date field.
func (f *DocumentRevisionHistoryFilter) WhereApprovalDate(p entql.TimeP) {
	f.Where(p.Field(documentrevisionhistory.FieldApprovalDate))
}

// WhereSubmittedByID applies the entql string predicate on the submitted_by_id field.
func (f *DocumentRevisionHistoryFilter) WhereSubmittedByID(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldSubmittedByID))
}

// WhereApprovedByID applies the entql string predicate on the approved_by_id field.
func (f *DocumentRevisionHistoryFilter) WhereApprovedByID(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldApprovedByID))
}

// WhereInternalPolicyID applies the entql string predicate on the internal_policy_id field.
func (f *DocumentRevisionHistoryFilter) WhereInternalPolicyID(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldInternalPolicyID))
}

// WhereProcedureID applies the entql string predicate on the procedure_id field.
func (f *DocumentRevisionHistoryFilter) WhereProcedureID(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldProcedureID))
}

// WhereActionPlanID applies the entql string predicate on the action_plan_id field.
func (f *DocumentRevisionHistoryFilter) WhereActionPlanID(p entql.StringP) {
	f.Where(p.Field(documentrevisionhistory.FieldActionPlanID))
}
...
// WhereHasDocumentRevisions applies a predicate to check if query has an edge document_revisions.
func (f *InternalPolicyFilter) WhereHasDocumentRevisions() {
	f.Where(entql.HasEdge("document_revisions"))
}

// WhereHasDocumentRevisionsWith applies a predicate to check if query has an edge document_revisions with a given conditions (other predicates).
func (f *InternalPolicyFilter) WhereHasDocumentRevisionsWith(preds ...predicate.DocumentRevision) {
	f.Where(entql.HasEdgeWith("document_revisions", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasDocumentRevisions applies a predicate to check if query has an edge document_revisions.
func (f *ProcedureFilter) WhereHasDocumentRevisions() {
	f.Where(entql.HasEdge("document_revisions"))
}

// WhereHasDocumentRevisionsWith applies a predicate to check if query has an edge document_revisions with a given conditions (other predicates).
func (f *ProcedureFilter) WhereHasDocumentRevisionsWith(preds ...predicate.DocumentRevision) {
	f.Where(entql.HasEdgeWith("document_revisions", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
