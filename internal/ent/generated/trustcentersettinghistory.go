...
type TrustCenterSettingHistory struct {
	...
	// URL of the trust center's remote logo
	LogoRemoteURL *string `json:"logo_remote_url,omitempty"`
	// The trust centers's local logo file id, takes precedence over the logo remote URL
	LogoLocalFileID *string `json:"logo_local_file_id,omitempty"`
	// URL of the trust center's remote favicon
	FaviconRemoteURL *string `json:"favicon_remote_url,omitempty"`
	// The trust centers's local favicon file id, takes precedence over the favicon remote URL
